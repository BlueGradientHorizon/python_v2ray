...
from python_v2ray.profile_parser import load_configs, ProxyProfile
...
def main():
    ...
    * and then use them with the ConnectionTester for ping tests.
    ...
    parsed_configs: List[ProxyProfile] = load_configs(
        subscription_url, is_subscription=True
    )
    ...
    results = tester.test_latency(profiles=parsed_configs, timeout=15)
