...
def main():
    ...
    * It dynamically builds a minimal Xray configuration (a SOCKS inbound and a direct outbound).
    ...
    )  # Xray typically requires at least one outbound
    ...
    try:
        ...
        with XrayCoreClient(
            ...
            if xray.is_running():
                ...
                print(
                    "* A local SOCKS proxy is available on 127.0.0.1:10808 (if you added the inbound)."
                )
                ...
                print(
                    "! Please check the 'vendor' path, executable permissions, or the dynamically generated config."
                )
                return
        ...
        print(f"! {e}")
        print(
            "! Please make sure you have downloaded the Xray core executable into the 'vendor' folder."
        )
